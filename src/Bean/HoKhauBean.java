...
public class HoKhauBean {
    ...
    public String toString() {
        String res = "<html> <style>p {padding: 5px; margin-left: 20px} table, th, td {border: 1px solid black; border-collapse: collapse;} table {width: 500px}</style> <div>"
                + "<h3>ThÃ´ng tin cÆ¡ báº£n"
                + "<p>MÃ£ há»™ kháº©u: <b>" + hoKhauModel.getMaHoKhau() + "</p>"
                + "<p>Há»� tÃªn chá»§ há»™: <b>" + chuHo.getHoTen() + "</p>"
                + "<p>Ä�á»‹a chá»‰: <b>" + hoKhauModel.getDiaChi() + "</p>"
                + "<p>NgÃ y láº­p: <b>" + hoKhauModel.getNgayLap().toString() + "</p>"
                + "<h4>Danh sÃ¡ch thÃ nh viÃªn<table>"
                + "<tr>"
                + "<th>Há»� tÃªn</th>"
                + "<th>NgÃ y sinh</th>"
                + "<th>Giá»›i tÃ­nh</th>"
                + "<th>Quan há»‡ vá»›i chá»§ há»™</th>"
                + "</tr>";
